...
" you can use this "3bF<T>i" sequence too instead of "3b2hi"

" same as above but for one word
	autocmd FileType html inoremap .w <Esc>vyi<<Esc>pa></<Esc>ea><Space><++><Esc>3b2hi

" No need to press Shift while exiting or saving - autosaving
